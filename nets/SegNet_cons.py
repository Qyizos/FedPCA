...
class SegNet(nn.Module):
    ...
    def __init__(self, inc=32, cons_predc=4, block=bottleNeck, nums=[3, 4, 6, 3]):
        seg_outc = 128
        # inc=32, cons_predc=4
...
def build_network(device, inc=32, cons_predc=4):
    return SegNet(inc, cons_predc, bottleNeck, device)